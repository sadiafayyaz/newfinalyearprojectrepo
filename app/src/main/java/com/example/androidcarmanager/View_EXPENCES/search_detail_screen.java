...
//                                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                                ...
                                searchOdometer.setText(String.valueOf(dataSnapshot.child("odometer").getValue(Double.class)));
                                searchPrice.setText(String.valueOf(dataSnapshot.child("price").getValue(Double.class)));
